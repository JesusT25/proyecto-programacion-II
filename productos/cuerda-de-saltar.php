...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Cuerda-Saltar'])) {
    $_SESSION['articulo'] = "Cuerda-Saltar";
...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/cuerda-de-saltar/cuerda-de-saltar.png" alt="Imagen 1 de la cuerda de saltar">

      <img src="../images/productos/cuerda-de-saltar/2.webp" alt="Imagen 2 de la cuerda de saltar">

      <img src="../images/productos/cuerda-de-saltar/3.webp" alt="Imagen 3 de la cuerda de saltar">

      <img src="../images/productos/cuerda-de-saltar/4.webp" alt="Imagen 4 de la cuerda de saltar">
    </div>

    <h1 class="titulo">Cuerda de saltar para ejercicio</h1>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Cuerda-Saltar" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        Cuerda de saltar de alta calidad con rodamientos antienredo, adicional viene con una bolsa para guardarla. Con
        ella
        puede mejorar su salud cardiovascular, resistencia y velocidad, mientras mejora la tensión muscular. Una
        excelente opción para cualquier tipo de entrenamiento, cardio, etc.
      </p>
    </details>
