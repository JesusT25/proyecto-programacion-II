...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Zapatos-Adidas-Duramo'])) {
    $_SESSION['articulo'] = "Zapatos-Adidas-Duramo";
...
<body>
  ...
  <main>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Zapatos-Adidas-Duramo" type="submit">Agregar al carrito</button>
