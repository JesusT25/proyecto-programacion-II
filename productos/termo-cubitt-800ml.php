...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Termo-Cubbit'])) {
    $_SESSION['articulo'] = "Termo-Cubbit";
...
<head>
  ...
  <title>Termo cubitt 800ml</title>
...
<body>
  ...
  <main>
    ...
    <div class="carrusel" id="termo-cubitt">
      <img src="../images/productos/termo-cubitt-800ml/img-1.webp" alt="Imagen 1 del termo cubitt">

      <img src="../images/productos/termo-cubitt-800ml/img-2.webp" alt="Imagen 2 del termo cubitt">

      <img src="../images/productos/termo-cubitt-800ml/img-3.webp" alt="Imagen 3 del termo cubitt">

      <img src="../images/productos/termo-cubitt-800ml/img-4.webp" alt="Imagen 4 del termo cubitt">
    </div>

    <h1 class="titulo">Termo térmico cubitt 800 ml</h1>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Termo-Cubbit" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        El termo térmico Cubitt de la marca Vacuum es el compañero perfecto para mantener tus bebidas a la temperatura
        ideal durante todo el día. Con su diseño clásico y elegante, este termo es ideal para llevar contigo a cualquier
        lugar. Su exterior de plástico garantiza durabilidad y resistencia, mientras que su interior de acero inoxidable
        mantiene tus bebidas frías durante 12 horas y calientes durante 8 horas. Gracias a su sistema de apertura a
        rosca con tapa, podrás disfrutar de tus bebidas sin preocuparte por derrames. Con una capacidad de 800 ml, este
        termo es ideal para mantenerte hidratado en tus actividades diarias.
      </p>
    </details>
