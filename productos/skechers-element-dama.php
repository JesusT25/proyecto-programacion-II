...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Zapatos-Skechers-Dama'])) {
    $_SESSION['articulo'] = "Zapatos-Skechers-Dama";
...
<head>
  ...
  <title>Zapatos deportivos skechers</title>
...
<body>
  ...
  <main>
    ...
    <div class="carrusel" id="skechers-dama">
      <img src="../images/productos/skechers-element-dama/skechers-element-dama.webp"
        alt="Imagen 1 de los zapatos deportivos skechers para dama">

      <img src="../images/productos/skechers-element-dama/2.webp"
        alt="Imagen 2 de los zapatos deportivos skechers para dama">

      <img src="../images/productos/skechers-element-dama/3.webp"
        alt="Imagen 3 de los zapatos deportivos skechers para dama">

      <img src="../images/productos/skechers-element-dama/4.webp"
        alt="Imagen 4 de los zapatos deportivos skechers para dama">
    </div>

    <h1 class="titulo">Zapatos deportivos Skechers Element 2.0 para Dama</h1>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Zapatos-Skechers-Dama" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        Potencia tus entrenamientos con las Skechers Skech-Air® Element 2.0 - New Beginnings. Estas zapatillas
        deportivas para
        dama están diseñadas para ofrecer la máxima comodidad y rendimiento. Con una parte superior de malla de
        ingeniería y
        detalles sintéticos, garantizan una excelente transpirabilidad y ajuste. La plantilla proporciona una sensación
        de
        frescura y amortiguación en cada paso, mientras que la entresuela  translúcida visible añade un toque moderno y
        soporte
        adicional. Perfectas para tus rutinas diarias, estas zapatillas te brindan el estilo y la funcionalidad que
        necesitas
