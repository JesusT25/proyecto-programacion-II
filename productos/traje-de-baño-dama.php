...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Traje-De-Baño-Dama'])) {
    $_SESSION['articulo'] = "Traje-De-Baño-Dama";
...
<head>
  ...
  <title>Traje de baño de dama</title>
...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/traje-de-baño-dama/traje-de-baño-dama.webp"
        alt="Imagen 1 del traje de baño de dama">

      <img src="../images/productos/traje-de-baño-dama/2.webp" alt="Imagen 2 del traje de baño de dama">

      <img src="../images/productos/traje-de-baño-dama/3.webp" alt="Imagen 3 del traje de baño de dama">
    </div>

    <h1 class="titulo">Traje de Baño para Dama</h1>

    <div class="ofertas">
      <p class="precio">10.00$</p>
      <p class="precio descuento">16.00$</p>
    </div>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Traje-De-Baño-Dama" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        El traje de baño Hind Olímpico, está diseñado con materiales de primera calidad. Este traje de baño de una sola
        pieza
        ofrece un ajuste que garantiza máxima comodidad y libertad de movimiento. Ideal para nadadoras y entusiastas del
        agua,
        combina estilo y funcionalidad, permitiéndote rendir al máximo en cada brazada. Su diseño aerodinámico y su
        tejido de
        secado rápido te mantendrán ligera y cómoda tanto dentro como fuera del agua.
      </p>
    </details>
