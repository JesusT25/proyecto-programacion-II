...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/saco-boxeo/saco-boxeo.jpg" alt="Imagen 1 del saco de boxeo">

      <img src="../images/productos/saco-boxeo/2.jpg" alt="Imagen 2 del saco de boxeo">

      <img src="../images/productos/saco-boxeo/3.jpg" alt="Imagen 3 del saco de boxeo">
    </div>

    <h1 class="titulo">Saco de boxeo Everlast 40 libras</h1>

    <div class="ofertas">
      <p class="precio">75.98$</p>
      <p class="precio descuento">89.39$</p>
    </div>
    ...
    <details class="detalles">
      ...
      <p>
        Lleva el boxeo y el entrenamiento de MMA al siguiente nivel con este saco de boxeo colgante de 40 libras,
        diseñado para
        soportar entrenamientos intensos. Construido de cuero sintético de alta calidad con correas reforzadas y relleno
        de
        mezcla de fibras, ofrece durabilidad y una experiencia realista. Su bucle de doble extremo permite conectarlo a
        varios
        puntos de anclaje, ofreciendo mayor funcionalidad en cada sesión.
      </p>
    </details>
