...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Zapatos-RS-Moon'])) {
    $_SESSION['articulo'] = "Zapatos-RS-Moon";
...
<head>
  ...
  <title>Zapatos deportivos rs moon</title>
...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/zapatos-deportivos-rs-moon/1.webp" alt="Imagen 1 de los zapatos deportivos rs moon">

      <img src="../images/productos/zapatos-deportivos-rs-moon/2.webp"
        alt="Imagen 2 de los zapatos deportivos rs moon">">

      <img src="../images/productos/zapatos-deportivos-rs-moon/3.webp"
        alt="Imagen 3 de los zapatos deportivos rs moon">">

      <img src="../images/productos/zapatos-deportivos-rs-moon/4.webp"
        alt="Imagen 4 de los zapatos deportivos rs moon">">
    </div>

    <h1 class="titulo">Zapatos Deportivos Rs Moon</h1>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Zapatos-RS-Moon" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        Muévete o corre por tu día sintiéndote confortable y listo para todo con estos zapatos RS Performance. Con una
        malla
        transpirable, que mantiene tus pies frescos incluso en los días de calor. La suela le aporta amortiguación a
        cada pisada
        que das, brindando transpirabilidad, sujeción, flexibilidad, y rendimiento.
      </p>
    </details>
