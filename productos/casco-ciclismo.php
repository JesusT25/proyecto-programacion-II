...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Casco-Ciclismo'])) {
    $_SESSION['articulo'] = "Casco-Ciclismo";
...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/casco-ciclismo/casco-ciclismo.webp" alt="Imagen 1 del casco de ciclismo">

      <img src="../images/productos/casco-ciclismo/2.webp" alt="Imagen 2 del casco de ciclismo">

      <img src="../images/productos/casco-ciclismo/3.webp" alt="Imagen 3 del casco de ciclismo">
    </div>

    <h1 class="titulo">Casco Ciclismo Ac Bikes</h1>

    <div class="ofertas">
      <p class="precio">15.99$</p>
      <p class="precio descuento">19.99$</p>
    </div>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Casco-Ciclismo" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        Descubre la protección y comodidad en cada aventura con los cascos de montaña de la marca AC BIKES. Diseñados
        para
        ofrecerte la máxima seguridad en tus recorridos, estos cascos con un ajuste perfecto y un diseño aerodinámico
        son
        ideales para todos los ciclistas, desde principiantes hasta profesionales. No solo te sentirás seguro, sino que
        también
        lucirás con estilo mientras conquistas cada sendero.
      </p>
    </details>
