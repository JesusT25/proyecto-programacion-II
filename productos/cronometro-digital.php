...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Cronometro-Digital'])) {
    $_SESSION['articulo'] = "Cronometro-Digital";
...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/cronometro-digital/cronometro-digital.webp" alt="Imagen 1 del cronometro digital">

      <img src="../images/productos/cronometro-digital/2.webp" alt="Imagen 2 del cronometro digital">

      <img src="../images/productos/cronometro-digital/3.webp" alt="Imagen 3 del cronometro digital">

      <img src="../images/productos/cronometro-digital/4.webp" alt="Imagen 4 del cronometro digital">
    </div>

    <h1 class="titulo">Cronómetro Digital Deportivo</h1>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Cronometro-Digital" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        Este Cronómetro digital deportivo es la herramienta ideal para los
        entusiastas del deporte que buscan precisión y funcionalidad. Diseñado con un material plástico ABS resistente,
        este
        cronómetro es perfecto para entrenamientos intensos y condiciones exigentes. Su resistencia al agua garantiza un
        rendimiento óptimo, sin importar el entorno.
      </p>
    </details>
