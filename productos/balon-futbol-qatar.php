...
$articulo = $_SESSION['articulo'] = $_SESSION['valor'] = "";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (isset($_POST['Balon-Futbol-Qatar-2022'])) {
    // $articulo = "Balon-Futbol-Qatar-2022";
    $_SESSION['articulo'] = "Balon-Futbol-Qatar-2022";
...
//Pasos para obtener el valor de la variable nombre (tabla productos)
  $consulta = $conexion->query("SELECT nombre FROM productos WHERE nombre = '$articulo'");

  if ($consulta->num_rows > 0) {
    $_SESSION[' articulo'] = $consulta->fetch_assoc()['nombre'];
  }
}
...
<head>
  ...
  <title>Balon De Futbol Mundial Qatar</title>
...
<body>
  ...
  <main>
    ...
    <div class="carrusel">
      <img src="../images/productos/balon-futbol-qatar/balon-futbol-qatar.webp"
        alt="Imagen 1 del balon De futbol mundial Qatar 2022">

      <img src="../images/productos/balon-futbol-qatar/2.webp" alt="Imagen 2 del balon De futbol mundial Qatar 2022">">

      <img src="../images/productos/balon-futbol-qatar/3.webp" alt="Imagen 3 del balon De futbol mundial Qatar 2022">">

      <img src="../images/productos/balon-futbol-qatar/4.webp" alt="Imagen 4 del balon De futbol mundial Qatar 2022">">
    </div>

    <h1 class="titulo">Balón De Futbol adidas Mundial Qatar 2022 N°5</h1>
    ...
    <form class="contenedor" method="POST">
      ...
      <button class="boton" name="Balon-Futbol-Qatar-2022" type="submit">Agregar al carrito</button>
    ...
    <details class="detalles">
      ...
      <p>
        El balón de fútbol presenta un diseño en color blanco con detalles multicolor inspirados en los rascacielos de
        Qatar
        durante la noche. Sus juntas están cosidas a máquina, lo que garantiza una buena resistencia a la abrasión y a
        la
        rotura. La cubierta, fabricada en poliuretano, mejora la durabilidad del balón. Además, cumple con el diámetro y
        el peso
        requeridos para un balón de talla 5.
